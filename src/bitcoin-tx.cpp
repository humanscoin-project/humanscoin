...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s humanscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  humanscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded humanscoin transaction") + "\n" +
              "  humanscoin-tx [options] -create [commands]   " + _("Create hex-encoded humanscoin transaction") + "\n" +
              "\n";
