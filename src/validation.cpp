...
#if defined(NDEBUG)
# error "Humanscoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Humanscoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s HUM additional fees, %d delta bytes\n",
