...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/humanscoin-project/humanscoin>";
    const std::string URL_WEBSITE = "<https://humanscoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Humanscoin version %s\n", FormatFullVersion());
}
